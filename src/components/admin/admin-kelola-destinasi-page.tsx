...
const AdminKelolaDestinasiPage = () => {
    ...
    <main className="flex h-screen">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="container mx-auto py-4 px-4 md:py-6 md:px-12">
          ...
          <AdminHeader
            headline="Admin Kelola Destinasi Travesia"
            tagline="Kelola wisata sistem Travesia"
          />
        </div>

        <section className="container mx-auto py-4 px-4 md:py-6 md:px-12">
          <div className="flex flex-wrap gap-4">kelola Destinasi</div>
        </section>
      </div>
    </main>
  );
